package dev.gaphunter.dockerfileunusedstagecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.dockerfileunusedstagecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.dockerfileunusedstagecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Dockerfile Unused Stage Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33803-dockerfile-unused-stage-companion/reviews"
